 ...
 * @date 2018/2/6.
 */
public class DB1Generator {

    final static String PATH = "/code/spring_code/mysugar/src/test/db1";
...
//        strategy.setInclude(new String[] { "user_role"}); // 需要生成的表
        ...
        pc.setParent("com.janedler.mysugar.db1");
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return PATH + "/db1/" + tableInfo.getEntityName() + "Mapper.xml";
            }
        });
        cfg.setFileOutConfigList(focList);
        mpg.setCfg(cfg);
