...
public class DB2Generator {
    ...
    final static String PATH = "/code/spring_code/mysugar/src/test/db2";
...
//        gc.setServiceImplName("%sServiceDiy");
        ...
        dsc.setUsername("app");
        dsc.setPassword("8Ns3jqRJ");
        dsc.setUrl("jdbc:mysql://101.132.139.239:3307/lydb?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true");
        ...
        strategy.setInclude(new String[] { "tb_user",
                "tb_circle_friends_comments",
                "tb_circle_friends_publish",
                "tb_user_id_card"}); // 需要生成的表
        ...
        pc.setParent("com.janedler.mysugar.db2");
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return PATH + "/db2/" + tableInfo.getEntityName() + "Mapper.xml";
            }
        });
        cfg.setFileOutConfigList(focList);
        mpg.setCfg(cfg);
